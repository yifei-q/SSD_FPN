...
'''How to organize your dataset folder:
  VOCROOT/
       ...
       |    |->...
'''
tf.app.flags.DEFINE_string('dataset_directory', 'F:/Sperms',
                           'All datas directory')
tf.app.flags.DEFINE_string('train_splits', '',
...
tf.app.flags.DEFINE_string('output_directory', 'F:/Sperms/tfrecords',
...
def _find_image_bounding_boxes(directory, cur_record):
  ...
  for obj in root.findall('object'):
      ...
      labels.append(int(dataset_common.SPERM_LABELS[label][0]))
