...
tf.app.flags.DEFINE_string('data_dir', 'F:/dataset/VOCROOT/tfrecords','The directory where the dataset input data is stored.')
...
tf.app.flags.DEFINE_integer('train_epochs', 1,'The number of epochs to use for training.')
tf.app.flags.DEFINE_integer('batch_size', 1,'Batch size for training and evaluation.')
...
tf.app.flags.DEFINE_float('select_threshold', 0.01, 'Class-specific confidence score threshold for selecting a box.')
...
tf.app.flags.DEFINE_integer('keep_topk', 400, 'Number of total object to keep for each image before nms.')
